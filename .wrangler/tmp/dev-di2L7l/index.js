...
var OpenAPIHono = class _OpenAPIHono extends Hono2 {
  ...
  getOpenAPIDocument = /* @__PURE__ */ __name((config) => {
    const generator = new OpenApiGeneratorV3(this.openAPIRegistry.definitions);
    const document = generator.generateDocument(config);
    return this._basePath ? addBasePathToDocument(document, this._basePath) : document;
  }, "getOpenAPIDocument");
  getOpenAPI31Document = /* @__PURE__ */ __name((config) => {
...
var LangParam = external_exports.enum(SUPPORTED_LANGUAGES).default("tr").openapi({
  param: { name: "lang", in: "query" },
  example: "tr"
});
var PageIndexParam = external_exports.coerce.number().int().min(0).default(0).openapi({
  param: { name: "pageIndex", in: "query" },
  example: 0
});
var PageSizeParam = external_exports.coerce.number().int().min(1).max(100).default(10).openapi({
...
function paginatedResponse(itemSchema) {
  return external_exports.object({
    ...
    data: external_exports.object({
      pageIndex: external_exports.number(),
      ...
      requestedLanguage: external_exports.string(),
      returnedLanguage: external_exports.string()
    })
  });
}
__name(paginatedResponse, "paginatedResponse");
function paginate(pageIndex, pageSize, totalCount) {
...
// src/routes/faqs.ts
var FaqItemSchema = external_exports.object({
...
var stories_default = stories;

// src/routes/religious-stories.ts
var ReligiousStoryItemSchema = external_exports.object({
  id: external_exports.string().uuid(),
  order: external_exports.number(),
  imageUrl: external_exports.string().url().nullable(),
  videoUrl: external_exports.string().url().nullable(),
  title: external_exports.string(),
  description: external_exports.string(),
...
var religiousStories = new OpenAPIHono();
...
var religious_stories_default = religiousStories;
...
app.route("/faqs", faqs_default);
app.route("/stories", stories_default);
app.route("/religious-stories", religious_stories_default);
...
// .wrangler/tmp/bundle-ieljhw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ieljhw/middleware-loader.entry.ts
